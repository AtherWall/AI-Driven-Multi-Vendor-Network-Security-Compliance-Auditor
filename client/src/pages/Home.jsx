...
function Home({ refreshUser }) {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-slate-950 text-white">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="mt-2 flex gap-3 border-t border-white/10 pt-4">
                ...
                <button
                  ...
                  className="flex-1 rounded-xl bg-blue-600 px-4 py-3 text-sm font-semibold"
                >
                  Get Started
                </button>
              </div>
          ...
          <div>
            ...
            <h1 className="max-w-3xl text-5xl font-bold leading-[1.05] tracking-tight sm:text-6xl lg:text-7xl">
              ...
              <span className="mt-2 block text-blue-500">
                Audit Every Configuration.
              </span>
            </h1>

            <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-400 sm:text-xl">
              Analyze network configurations across vendors, identify
              security weaknesses, evaluate compliance, and get actionable
              remediation recommendations from one platform.
            </p>

            <div className="mt-9 flex flex-col gap-4 sm:flex-row">
              <button
                onClick={() => switchAuthMode("signup")}
                className="group flex items-center justify-center gap-3 rounded-xl bg-blue-600 px-7 py-4 font-semibold shadow-xl shadow-blue-600/20 transition hover:bg-blue-500"
              >
                Start Auditing
      ...
      <section
        id="frameworks"
        className="border-y border-white/5 bg-slate-900/50 px-6 py-16 lg:px-8"
      >
        <div className="mx-auto max-w-7xl text-center">
          <p className="text-sm font-medium uppercase tracking-[0.2em] text-slate-500">
            Built for heterogeneous networks
          </p>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-400">
              A centralized security platform designed to make multi-vendor
              network auditing faster, smarter, and easier to understand.
            </p>
          </div>
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <FeatureCard
              icon={<FaUploadIcon />}
              title="Unified Configuration Ingestion"
              description="Upload configurations from firewalls, routers, switches, cloud environments, and other network devices from one centralized platform."
            />

            <FeatureCard
              icon={<FaBrain />}
              title="AI-Powered Analysis"
              description="Use AI-assisted pattern recognition to understand configuration structures and identify security-related settings across different vendors."
            />

            <FeatureCard
              icon={<FaShieldAlt />}
              title="Multi-Framework Compliance"
              description="Evaluate network configurations against security frameworks such as CIS, NIST, DISA STIGs, and ISO/IEC 27001."
            />

            <FeatureCard
              icon={<FaNetworkWired />}
              title="Network Topology"
              description="Visualize devices and their relationships to understand how your network infrastructure is connected."
            />

            <FeatureCard
              icon={<FaChartLine />}
              title="Risk & Compliance Insights"
              description="See compliance status, security gaps, severity levels, and areas that require administrator attention."
            />

            <FeatureCard
              icon={<FaFileAlt />}
              title="Actionable Reports"
              description="Generate detailed reports with device information, compliance findings, risk severity, and remediation recommendations."
            />
          </div>
        </div>
      </section>
      ...
      <section
        id="how-it-works"
        className="border-y border-white/5 bg-slate-900/50 px-6 py-24 lg:px-8"
      >
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            <span className="text-sm font-semibold uppercase tracking-[0.2em] text-blue-400">
            ...
            <h2 className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl">
              From configuration to remediation
            </h2>

            <p className="mt-5 text-lg leading-8 text-slate-400">
              A simple workflow for turning raw network configurations into
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <StepCard
              ...
              icon={<FaUploadIcon />}
              title="Upload"
              description="Upload a device configuration file to the platform."
            />
            ...
            <StepCard
              ...
              icon={<FaBrain />}
              title="Analyze"
              description="The system processes and normalizes the configuration."
            />
            ...
            <StepCard
              ...
              icon={<FaShieldAlt />}
              title="Audit"
              description="Evaluate the configuration against security requirements."
            />
            ...
            <StepCard
              ...
              icon={<FaArrowRight />}
              title="Remediate"
              description="Get clear recommendations to fix identified issues."
            />
          </div>
        </div>
      </section>
        ...
        <div className="relative mx-auto max-w-5xl overflow-hidden rounded-3xl border border-blue-500/20 bg-blue-600/10 p-10 text-center sm:p-16">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-400">
              Start analyzing your network configurations and discover
              security weaknesses before they become problems.
            </p>

            <button
              onClick={() => switchAuthMode("signup")}
              className="mt-8 inline-flex items-center gap-3 rounded-xl bg-blue-600 px-7 py-4 font-semibold shadow-xl shadow-blue-600/20 transition hover:bg-blue-500"
            >
              Get Started
              <FaArrowRight />
            </button>
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Intelligent security for modern networks
              </p>
            </div>
          </div>

          <p className="text-xs text-slate-600">
            © 2026 AI Network Security Auditor. All rights reserved.
          </p>
        </div>
      </footer>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/80 px-4 backdrop-blur-md">
          <div className="relative w-full max-w-md overflow-hidden rounded-3xl border border-white/10 bg-slate-900 shadow-2xl">
            <button
              ...
              className="absolute right-5 top-5 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-white/5 text-slate-400 transition hover:bg-white/10 hover:text-white"
            >
              <FaTimes />
            </button>
              ...
              <div className="mb-7 text-center">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-400">
                  {authMode === "login"
                    ...
                    : "Create an account and start auditing your network."}
                </p>
              </div>
              ...
              {authMode === "login" ? (
                <form onSubmit={handleLogin} className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      disabled={loading}
                      className="w-full rounded-xl border border-white/10 bg-slate-950 px-4 py-3 text-sm text-white outline-none placeholder:text-slate-600 transition focus:border-blue-500 disabled:opacity-50"
                    />
                  </div>
                ...
                <form onSubmit={handleSignup} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="mt-2 w-full rounded-xl bg-blue-600 px-5 py-3.5 font-semibold text-white transition hover:bg-blue-500 disabled:cursor-not-allowed disabled:opacity-60"
                  >
